class Functions {
  ...
  init() {
    ...
    this.items.newTab.addEventListener("click", () =>
      this.tabs.createTab("absent://newtab")
    );
  }
    ...
    let content = this.ui.createElement("div", {}, [
      ...
      this.ui.createElement(
        "div",
        {
          ...
          id: "openHistory",
          onclick: () => {
            this.tabs.createTab("absent://history");
          },
        },
        [
          this.ui.createElement(
      ...
      this.ui.createElement(
        "div",
        {
          ...
          id: "openGames",
          onclick: () => {
            this.tabs.createTab("absent://games");
          },
        },
        [
          this.ui.createElement(
      ...
      this.ui.createElement(
        "div",
        {
          ...
          id: "openExtensions",
          onclick: () => {
            this.tabs.createTab("absent://extensions");
          },
        },
        [
          this.ui.createElement(
      ...
      this.ui.createElement(
        "div",
        {
          ...
          id: "settingsFromMenu",
          onclick: () => {
            this.tabs.createTab("absent://settings");
          },
        },
        [
          this.ui.createElement(
  ...
  navbarfunctions() {
    ...
    games.addEventListener("click", () => {
      this.utils.navigate("absent://games");
    });
    ...
    history.addEventListener("click", () => {
      this.utils.navigate("absent://history");
    });

    settings.addEventListener("click", () => {
      this.utils.navigate("absent://settings");
    });
  }
}
