...
> Supported versions of ABSENT are as followed:
...
The current version of ABSENT is **v1.0.0**

> [!IMPORTANT]
> If you do not have the current version of ABSENT please update
...
Thank you for surfing the web using ABSENT.